...
import gcp.springmvc.manager.WorkersManager;
	...
	**/
    ...
    public @ResponseBody Map<String,Object> query(@ModelAttribute("pubParamBean")PubParamBean pubParamBean, ModelMap map){
		...
		try{
	    	...
	    	List<WorkersBean> listBean = mWorkersManager.query(cxInBean, pubParamBean);
	    	if(listBean==null){
	    		rtnMap.put("rows", "[]");
	    	}else{
